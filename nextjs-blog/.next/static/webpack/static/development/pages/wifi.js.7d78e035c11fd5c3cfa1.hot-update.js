...
function Home() {
  function fourthScript() {
    console.log("Called");
    var temp = fetch('http://127.0.0.1:3001/change_add_wifi_network').then(function (response) {
      return response;
    });
    console.log(temp);
  }
